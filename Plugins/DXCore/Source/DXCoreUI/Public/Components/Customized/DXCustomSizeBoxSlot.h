...
#include "DXCustomSizeBoxSlot.generated.h"

class SDXCustomBox;

/** The Slot for the USizeBoxSlot, contains the widget displayed in a button's single slot */
UCLASS()
class DXCOREUI_API UDXCustomSizeBoxSlot : public UPanelSlot
{
...
public:
	...
	void BuildSlot(TSharedRef<SDXCustomBox> InSizeBox);
