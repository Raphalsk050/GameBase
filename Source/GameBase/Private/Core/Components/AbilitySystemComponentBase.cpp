...
void UAbilitySystemComponentBase::SetInputBinding(UInputAction* InputAction, FGameplayAbilitySpecHandle AbilityHandle)
{
...
void UAbilitySystemComponentBase::ClearInputBinding(FGameplayAbilitySpecHandle AbilityHandle)
{
	using namespace EnhancedInputAbilitySystem_Impl;
...
void UAbilitySystemComponentBase::ClearAbilityBindings(UInputAction* InputAction)
{
	RemoveEntry(InputAction);
}

void UAbilitySystemComponentBase::SetInputComponent(UEnhancedInputComponent* InputComponent)
{
	this->EnhancedInputComponent = InputComponent;
}

void UAbilitySystemComponentBase::OnAbilityInputPressed(UInputAction* InputAction)
{
	using namespace EnhancedInputAbilitySystem_Impl;
...
void UAbilitySystemComponentBase::OnAbilityInputReleased(UInputAction* InputAction)
{
	using namespace EnhancedInputAbilitySystem_Impl;
...
void UAbilitySystemComponentBase::RemoveEntry(UInputAction* InputAction)
{
...
FGameplayAbilitySpec* UAbilitySystemComponentBase::FindAbilitySpec(FGameplayAbilitySpecHandle Handle)
{
...
void UAbilitySystemComponentBase::TryBindAbilityInput(UInputAction* InputAction, FAbilityInputBinding& AbilityInputBinding)
{
	if (EnhancedInputComponent)
	{
		// Pressed event
		...
		{
			AbilityInputBinding.OnPressedHandle = EnhancedInputComponent->BindAction(InputAction, ETriggerEvent::Started, this, &UAbilitySystemComponentBase::OnAbilityInputPressed, InputAction).GetHandle();
		}

		// Released event
		if (AbilityInputBinding.OnReleasedHandle == 0)
		{
			AbilityInputBinding.OnReleasedHandle = EnhancedInputComponent->BindAction(InputAction, ETriggerEvent::Completed, this, &UAbilitySystemComponentBase::OnAbilityInputReleased, InputAction).GetHandle();
		}
	}
}
